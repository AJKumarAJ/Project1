...
var events_log = require('./routes/events_log'); 
...
app.post('/taskend_status/a?status=2',ensureLoggedIn,user_update.task_complete);
app.post('/push_notifications',ensureLoggedIn,notify.push_notify);
app.get('/events_log',ensureLoggedIn,events_log.log);
